    ...
    <header className="w-100 px-32 py-5">
      <nav className="flex flex-row justify-between w-100 items-center">
        ...
        <ul className="flex flex-row justify-between w-[40%]">
          <li>
            <Link href={routes.analise}>Análise</Link>
          </li>
          <li>
            <Link href={routes.relatorio}>Relatório</Link>
          </li>
          <li>
            <Link href={routes.diferenca}>Diferença</Link>
          </li>
        </ul>
        <div className="flex justify-end gap-5 w-[30%] items-center">
          <Link href={routes.signup}>Criar conta</Link>
          <Link href={routes.login} className="bg-primary py-1 px-4 rounded-lg">
            Login
          </Link>
        </div>
      </nav>
